      ...
      <div className="relative">
        ...
        <div className="w-full flex justify-center items-center py-24 font-inter">
          <div className="w-[80%] sm:w-[50%] bg-[#9ECD54] bg-opacity-25 px-6 py-12 flex flex-col justify-center items-center rounded-lg">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-[#9ECD54] mb-4 ">Thank You</h1>
            <p className="mb-2 text-sm sm:text-base text-center">You will be redirected back to the Contact page in <span className="font-bold text-blue-700">{countdown} seconds. </span></p>
            <p className="text-sm sm:text-base text-center">Or click here to go to the Official Website:</p>
            <button onClick={handleHomeClick} className="py-2 px-4 border border-black bg-black text-white rounded-lg mt-2">
              Click Here
            </button>
          </div>
        </div>
